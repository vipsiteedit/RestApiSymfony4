 ...
 */
final class Version20191029221149 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE import_log (id INT AUTO_INCREMENT NOT NULL, game_buffer_id INT NOT NULL, game_id INT NOT NULL, source_info_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
